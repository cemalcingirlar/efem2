...
const BASE_PRODUCTS = [
  ...
  // ── Apple ──
  {
    ...
    specs: [
      { key: "Ekran",      value: "42mm LTPO3 Always-On OLED" },
      { key: "İşlemci",    value: "Apple S10 SiP" },
      { key: "Batarya",    value: "24 saate kadar" },
      { key: "Dayanıklılık", value: "50m su direnci + IP6X" },
      { key: "Bağlantı",   value: "GPS + Bluetooth 5.3 + Wi-Fi" },
  ...
  },
  {
    ...
    specs: [
      { key: "Ekran",      value: "46mm LTPO3 Always-On OLED" },
      { key: "İşlemci",    value: "Apple S10 SiP" },
      { key: "Batarya",    value: "24 saate kadar" },
      { key: "Dayanıklılık", value: "50m su direnci + IP6X" },
      { key: "Bağlantı",   value: "GPS + Bluetooth 5.3 + Wi-Fi" },
  ...
  },
  {
    ...
    specs: [
      { key: "Ekran",      value: "40mm Always-On Retina" },
      { key: "İşlemci",    value: "Apple S10 SiP" },
      { key: "Batarya",    value: "18 saat (hızlı şarj destekli)" },
      { key: "Dayanıklılık", value: "50m su direnci + IP6X" },
      { key: "Sağlık",     value: "Uyku apnesi, bilekten sıcaklık, düşme algılama" },
      { key: "Kayış",      value: "Sport Band (S/M ve M/L)" }
    ],
    brand: "Apple",
    featured: true
  },
  {
    ...
    specs: [
      { key: "Ekran",      value: "44mm Always-On Retina" },
      { key: "İşlemci",    value: "Apple S10 SiP" },
      { key: "Batarya",    value: "18 saat (hızlı şarj destekli)" },
      { key: "Dayanıklılık", value: "50m su direnci + IP6X" },
      { key: "Sağlık",     value: "Uyku apnesi, bilekten sıcaklık, düşme algılama" },
  ...
  },
  {
    ...
    specs: [
      { key: "Ekran",      value: "46mm geniş açılı LTPO3 OLED" },
      { key: "İşlemci",    value: "Apple S10 SiP" },
      { key: "Kasa",       value: "Jet Black alüminyum" },
      { key: "Batarya",    value: "18 saat (hızlı şarj destekli)" },
      { key: "Dayanıklılık", value: "50m su direnci + IP6X, derinlik ölçer" },
      { key: "Bağlantı",   value: "GPS + Cellular + Bluetooth 5.3" },
  ...
  },
  {
    ...
    specs: [
      { key: "Ekran",      value: "42mm geniş açılı LTPO3 OLED, safir kristal" },
      { key: "İşlemci",    value: "Apple S10 SiP" },
      { key: "Kasa",       value: "Cilalı titanyum (Gold / Silver)" },
      { key: "Batarya",    value: "18 saat (hızlı şarj destekli)" },
      { key: "Dayanıklılık", value: "50m su direnci + IP6X" },
      { key: "Bağlantı",   value: "GPS + Cellular + Bluetooth 5.3" },
  ...
  },
  {
    ...
    specs: [
      { key: "Ekran",      value: "46mm geniş açılı LTPO3 OLED, safir kristal" },
      { key: "İşlemci",    value: "Apple S10 SiP" },
      { key: "Kasa",       value: "Cilalı titanyum (Natural / Gold / Silver)" },
      { key: "Batarya",    value: "18 saat (hızlı şarj destekli)" },
      { key: "Dayanıklılık", value: "50m su direnci + IP6X, derinlik ölçer" },
      { key: "Bağlantı",   value: "GPS + Cellular + Bluetooth 5.3" },
  ...
  },
  {
    ...
    specs: [
      { key: "Ekran",      value: "41mm Always-On Retina, 2000 nit" },
      { key: "İşlemci",    value: "Apple S9 SiP" },
  ...
  // ── Huawei ──
  {
    ...
    specs: [
      { key: "Ekran",      value: "1.43 inç AMOLED 466×466, safir kristal" },
      { key: "Kasa",       value: "Titanyum" },
      { key: "Batarya",    value: "14 güne kadar (tipik kullanım)" },
      { key: "Dayanıklılık", value: "5ATM + IP69" },
      { key: "Sağlık",     value: "TruSense, EKG, SpO2, nabız, stres" },
      { key: "Bağlantı",   value: "Çift bantlı GNSS + Bluetooth 5.2" },
    ],
    brand: "Huawei",
    featured: true
  },
  {
    ...
    specs: [
      { key: "Ekran",      value: "1.32 inç AMOLED 466×466" },
      { key: "Batarya",    value: "14 güne kadar (tipik kullanım)" },
      { key: "Dayanıklılık", value: "5ATM + IP69" },
      { key: "Sağlık",     value: "TruSense, SpO2, nabız, uyku, stres" },
      { key: "Bağlantı",   value: "Çift bantlı GNSS + Bluetooth 5.2" },
    ],
    brand: "Huawei",
    featured: false
  ...
  },
  {
    ...
    specs: [
      { key: "Ekran",      value: "1.47 inç AMOLED 466×466" },
      { key: "Batarya",    value: "21 güne kadar (tipik kullanım)" },
      { key: "Dayanıklılık", value: "5ATM + IP69" },
      { key: "Sağlık",     value: "TruSense, SpO2, nabız, uyku, stres" },
      { key: "Bağlantı",   value: "Çift bantlı GNSS + Bluetooth 5.2" },
    ],
  ...
  },
  {
    ...
    specs: [
      { key: "Ekran",      value: "1.47 inç AMOLED, safir kristal" },
      { key: "Batarya",    value: "21 güne kadar (tipik kullanım)" },
      { key: "Dayanıklılık", value: "5ATM + IP69, 40m dalış" },
      { key: "Sağlık",     value: "TruSense, EKG, SpO2, nabız, stres" },
      { key: "Bağlantı",   value: "Çift bantlı GNSS + Bluetooth 5.2" },
    ],
    brand: "Huawei",
  ...
  },
  {
    ...
    specs: [
      { key: "Ekran",      value: "1.82 inç AMOLED 480×408" },
      { key: "Kasa",       value: "Alüminyum alaşım, ultra ince" },
      { key: "Batarya",    value: "10 güne kadar (tipik kullanım)" },
  ...
  // ── Samsung ──
  {
    ...
    specs: [
      { key: "Ekran",      value: "1.34 inç Super AMOLED, safir kristal" },
      { key: "İşlemci",    value: "Exynos W1000" },
      { key: "Depolama",   value: "64GB" },
      { key: "Batarya",    value: "445mAh" },
      { key: "Dayanıklılık", value: "5ATM + IP68 + MIL-STD-810H" },
      { key: "Özellik",    value: "Döner çerçeve, Wear OS" },
    ],
    brand: "Samsung",
    featured: false
  },
  {
    ...
    specs: [
      { key: "Ekran",      value: "40mm Super AMOLED" },
      { key: "Platform",   value: "Wear OS + One UI Watch" },
      { key: "Sağlık",     value: "BioActive sensör (nabız, EKG, vücut analizi)" },
      { key: "Dayanıklılık", value: "5ATM + IP68 + MIL-STD-810H" },
      { key: "Bağlantı",   value: "GPS + Bluetooth + Wi-Fi + NFC" },
    ],
    brand: "Samsung",
    featured: true
  },
  {
    ...
    specs: [
      { key: "Ekran",      value: "44mm Super AMOLED" },
      { key: "Platform",   value: "Wear OS + One UI Watch" },
      { key: "Sağlık",     value: "BioActive sensör (nabız, EKG, vücut analizi)" },
      { key: "Dayanıklılık", value: "5ATM + IP68 + MIL-STD-810H" },
      { key: "Bağlantı",   value: "GPS + Bluetooth + Wi-Fi + NFC" },
  ...
  },
  {
    ...
    specs: [
      { key: "Ekran",      value: "AMOLED, yüksek parlaklık" },
      { key: "Batarya",    value: "Uzun ömürlü (tipik kullanımda günlerce)" },
      { key: "Dayanıklılık", value: "5ATM" },
      { key: "Bağlantı",   value: "GPS + Bluetooth arama" },
      { key: "Sağlık",     value: "SpO2, nabız, uyku, stres takibi" },
    ],
    brand: "Xiaomi",
    featured: true
  },
  ...
  // ── Apple ──
  {
    ...
    specs: [
      { key: "Çip",        value: "Apple H2" },
      { key: "Ses",        value: "Kişiselleştirilmiş Uzamsal Ses, Uyarlanabilir EQ" },
      { key: "Batarya",    value: "5 saat + 30 saat (kılıf)" },
      { key: "Bağlantı",   value: "Bluetooth 5.3" },
      { key: "Dayanıklılık", value: "IP54 (kulaklık ve kılıf)" },
  ...
  },
  {
    ...
    specs: [
      { key: "Çip",        value: "Apple H2" },
      { key: "Gürültü Engelleme", value: "Aktif ANC, Şeffaflık, Uyarlanabilir Ses" },
      { key: "Özellik",    value: "Konuşma Farkındalığı" },
      { key: "Batarya",    value: "4 saat (ANC açık) + 20 saat (kılıf)" },
      { key: "Dayanıklılık", value: "IP54 (kulaklık ve kılıf)" },
      { key: "Şarj",       value: "USB-C + kablosuz şarj, hoparlörlü kılıf" },
    ],
    brand: "Apple",
    featured: true
  },
  {
    ...
    desc: "AirPods Pro 3, Apple'ın şimdiye kadarki en güçlü gürültü engellemesini sunar. Köpük katmanlı kulaklıklarla daha iyi yalıtım, kalp atışı sensörü ve Canlı Çeviri desteği.",
    specs: [
      { key: "Çip",        value: "Apple H2" },
      { key: "Gürültü Engelleme", value: "Yeni nesil Aktif ANC (2× daha etkili)" },
      { key: "Sağlık",     value: "Kalp atış hızı sensörü" },
      { key: "Özellik",    value: "Canlı Çeviri, Uyarlanabilir Ses" },
      { key: "Batarya",    value: "8 saat (ANC açık)" },
      { key: "Dayanıklılık", value: "IP57" },
      { key: "Şarj",       value: "USB-C + MagSafe kablosuz" }
    ],
    brand: "Apple",
    featured: true
  },
  ...
  // ── Huawei ──
  {
    ...
    specs: [
      ...
      { key: "Sürücü",     value: "Dinamik sürücü" },
      { key: "Batarya",    value: "Kılıfla birlikte uzun kullanım" },
      { key: "Bağlantı",   value: "Bluetooth 5.3" },
  ...
  },
  {
    ...
    specs: [
      { key: "Tip",        value: "Kulak içi TWS" },
      { key: "Gürültü Engelleme", value: "Aktif ANC + Şeffaflık modu" },
      { key: "Özellik",    value: "Galaxy AI desteği, otomatik cihaz geçişi" },
      { key: "Bağlantı",   value: "Bluetooth + Multipoint" },
      { key: "Dayanıklılık", value: "IP54" },
    ],
    brand: "Samsung",
    featured: true
  },
  {
    ...
    specs: [
      { key: "Tip",        value: "Kulak içi TWS" },
      { key: "Gürültü Engelleme", value: "Gelişmiş Aktif ANC" },
      { key: "Ses",        value: "360 Audio, Hi-Fi ses" },
      { key: "Özellik",    value: "Galaxy AI desteği, otomatik cihaz geçişi" },
      { key: "Bağlantı",   value: "Bluetooth + Multipoint" },
      { key: "Dayanıklılık", value: "IP54" },
    ],
  ...
  },
  {
    ...
    specs: [
      { key: "Tip",        value: "Kulak içi TWS" },
      { key: "Gürültü Engelleme", value: "Aktif ANC" },
      { key: "Batarya",    value: "Kılıfla uzun süreli kullanım" },
      { key: "Bağlantı",   value: "Bluetooth 5.4" },
      { key: "Dayanıklılık", value: "IP54" },
    ],
    brand: "Xiaomi",
  ...
  },
  {
    ...
    specs: [
      { key: "Tip",        value: "Kulak içi TWS" },
      { key: "Özellik",    value: "Düşük gecikme oyun modu" },
      { key: "Batarya",    value: "Kılıfla uzun süreli kullanım" },
      { key: "Bağlantı",   value: "Bluetooth 5.4" },
      { key: "Dayanıklılık", value: "IPX4" },
    ],
  ...
  },
  {
    ...
    specs: [
      { key: "Tip",        value: "Kulak içi TWS" },
      { key: "Özellik",    value: "Hızlı eşleşme, çağrı gürültü azaltma" },
      { key: "Batarya",    value: "Kılıfla uzun süreli kullanım" },
      { key: "Bağlantı",   value: "Bluetooth 5.4" },
      { key: "Dayanıklılık", value: "IPX4" },
    ],
  ...
  },
  {
    ...
    specs: [
      { key: "Tip",        value: "Kulak içi TWS" },
      { key: "Gürültü Engelleme", value: "55dB'ye kadar Aktif ANC" },
      { key: "Mikrofon",   value: "3 mikrofonlu AI çağrı gürültü azaltma" },
      { key: "Batarya",    value: "8 saat + 33 saat (kılıf)" },
      { key: "Bağlantı",   value: "Bluetooth 5.4" },
    ],
    brand: "Xiaomi",
    featured: true
  ...
  },
  {
    ...
    specs: [
      ...
      { key: "Malzeme",    value: "Dokuma kumaş" },
      { key: "Bağlantı",   value: "Manyetik uçlar" },
      { key: "Özellik",    value: "Ayarlanabilir uzunluk" },
    ],
    brand: "Apple",
    featured: false
  },
...

  {
    ...
    desc: "Huawei WiFi Mesh X3 Pro, evinizin her köşesine kesintisiz Wi-Fi 6 kapsaması sağlar. Mesh yapısı sayesinde odalar arasında geçerken bağlantınız kopmaz.",
    specs: [
      { key: "Standart",   value: "Wi-Fi 6" },
      { key: "Yapı",       value: "Mesh (çoklu ünite desteği)" },
      { key: "Model",      value: "PLM21-20" },
      { key: "Özellik",    value: "Otomatik kanal seçimi, ebeveyn kontrolü" },
    ],
    brand: "Huawei",
    featured: false
  },
